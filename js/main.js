...
(function($) {
    ...
    * ------------------------------------------------------ */
    const ssFinalCountdown = function() {
        ...
        const finalDate = '2022/07/07';

        $('.counter').countdown(finalDate)
        .on('update.countdown finish.countdown', function(event) {

            const str = '<div class=\"counter__time days\">%D&nbsp;<span>Μ</span></div>' +
                        '<div class=\"counter__time hours\">%H&nbsp;<span>Ω</span></div>' +
                        '<div class=\"counter__time minutes\">%M&nbsp;<span>Λ</span></div>' +
                        '<div class=\"counter__time seconds\">%S&nbsp;<span>Δ</span></div>';
